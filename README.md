...
- ✅ **Linux Essentials** — Completed
- ✅ **Git & GitHub** — Completed with Jadi on Maktabkhooneh
- 🔄 **Python** — Currently learning
- ⏳ **Docker** — Coming up
- ⏳ **CI/CD** — Coming up
- ⏳ **Infrastructure as Code** — Coming up
- ⏳ **Kubernetes** — Coming up
- ⏳ **Cloud & Monitoring** — Coming up

#### Tech I'm learning

`Python` `Bash` `Linux` `Git` `GitHub` `Docker` (coming up) `Kubernetes` (coming up)
...
- ✅ **Linux Essentials** — تکمیل شده
- ✅ **Git و GitHub** — تکمیل شده با دوره جادی در مکتب‌خونه
- 🔄 **Python** — در حال یادگیری
- ⏳ **Docker** — به‌زودی
- ⏳ **CI/CD** — به‌زودی
- ⏳ **Infrastructure as Code** — به‌زودی
- ⏳ **Kubernetes** — به‌زودی
- ⏳ **Cloud و Monitoring** — به‌زودی

#### تکنولوژی‌هایی که در حال یادگیری‌شان هستم

`Python` `Bash` `Linux` `Git` `GitHub` `Docker` (به‌زودی) `Kubernetes` (به‌زودی)
